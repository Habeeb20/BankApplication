    ...
    public class TransactionRepository : ITransactionRepository
    {
        ...
        public bool Add(Transaction transaction)
        {
            if (transaction is not null)
            {
                ...
                using StreamWriter writer = new StreamWriter(ProjectOOP.ApplicationConstants.FileConstants.TRANSACTION, true);
                writer.WriteLine();
                writer.Flush();
                writer.Close();
                return true;
        ...
        {
            var transactPath = Path.Combine(Directory.GetCurrentDirectory(), ProjectOOP.ApplicationConstants.FileConstants.TRANSACTION);
